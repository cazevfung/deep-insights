...
### 事实（Facts）
#### 定义
客观描述，可以被证实或证伪，不包含主观判断

#### 对应字段
`key_facts`, `key_facts_from_comments`
...
#### 对应字段
`key_opinions`, `key_opinions_from_comments`

### 数据（Data）
#### 定义
具体的数字，定量信息，统计、度量、比例、百分比、金额等

#### 对应字段
`key_datapoints`, `key_datapoints_from_comments`
