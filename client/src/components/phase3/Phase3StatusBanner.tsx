  ...
  return (
    <div className="space-y-4 mb-4">
      {rerunState?.inProgress && (
        <div className="bg-primary-50 border border-primary-200 text-primary-700 rounded-xl p-4 text-sm shadow-sm">
      ...
      {reportStale && (
        <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 rounded-xl p-4 text-sm shadow-sm">
